...
class ThinkboxMYLibraryConan(ConanFile):
    ...
    description: str = 'The XMesh Plugin for Maya'
    ...
    def build(self) -> None:
        version_gen.write_version_file(self.version, os.path.join(self.source_folder, 'XMeshVersion.h'))
    ...
    def export_sources(self) -> None:
        ...
        self.copy('XMesh.exp', src='', dst='')
        self.copy('XMesh.map', src='', dst='')
        self.copy('*', dst='icons', src='icons')
        self.copy('*', dst='scripts', src='scripts')
        self.copy('*', dst='BitRockInstaller', src='BitRockInstaller')
                ...
                if name not in NO_LICENSE_ALLOWLIST:
                    ...
                    for licensefile in os.listdir(licensedir):
                        ...
                        if licensefilepath not in UNUSED_LICENSE_DENYLIST:
                            with open(licensefilepath, 'r') as license:
